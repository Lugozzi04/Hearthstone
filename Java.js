...
function cambiaSfondo1(){
  document.getElementById("ad").style.backgroundImage = "url(img/g.jpg)";
...
function cambiaSfondo2(){
  document.getElementById("ad").style.backgroundImage = "url(img/ad.jpg)";
...
function inCom(){
  document.getElementById("ad").style.backgroundImage = "url(img/b4.jpg)";
  document.getElementById("x").style.display="none";
  document.getElementById("a").style.display="none";
  document.getElementById("vod").style.display="none";
  document.getElementById("perche").style.display="none";
...
function gr(){
  document.getElementById("ad").style.backgroundImage = "url(img/grazie.jpg)";
  document.getElementById("x").style.display="none";
  document.getElementById("a").style.display="none";
  document.getElementById("vod").style.display="none";
  document.getElementById("perche").style.display="none";
...
function clicco(){
  if(upvote%2==0){
    ...
    upvote++;
    document.getElementById("up").style.backgroundImage = "url(img/pV.png)";

  }else{
  document.getElementById("SpanID").textContent="+6";
  upvote++;
  document.getElementById("up").style.backgroundImage = "url(img/upVote.png)";
  }
